filename = 'Exp21-23022023-Part.txt';
...
bar_categories = categorical(exp20_longestrange{1,exp20_longestrange.Properties.VariableNames(10:numvariables)});
...
subtitle("As percentages of total volume for each trial. 13 snapshots total.","FontSize",9)
grid on
